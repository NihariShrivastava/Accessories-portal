...
import { ManageCountersView, ModelDetailView, ReportsView, BillsView, AddCounterView } from '../components/dashboard/sub-views/AdminSubViews';
...
export function AdminDashboard() {
  ...
  if (activeView === 'logins') {
    ...
    content = <AddCounterView onBack={() => { fetchCounters(); setActiveView('logins'); }} />;
    ...
    content = (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {vehicleModels.map(m => (
            <button key={m} onClick={() => handleModelClick(m)} className="flex items-center justify-between p-4 bg-card border border-border rounded-lg hover:bg-muted group">
