            ...
            columns={[
              ...
              { 
                ...
                accessor: (b) => {
                  ...
                  return <span className={amt < 0 ? 'text-emerald-600 dark:text-emerald-400' : amt > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-foreground'}>{sign}₹{Math.abs(amt).toFixed(2)}</span>;
                }, 
